...
namespace G01_Perseus
{
    public static class EntityManager
    {
        ...
        {
            Player = new Player(AssetManager.SpriteAsset("player_ship"), new Vector2(250, 250), new Vector2(500, 500), new Vector2(0.2f, 0.2f), null, SpriteEffects.None, Color.White, 0f, 0.85f, true, 100);
            entities.Add(Player);
        }

        public static void CreateEnemy()
        {
            entities.Add(new Enemy(AssetManager.SpriteAsset("enemy_ship"), new Vector2(250, 50), new Vector2(400, 400), new Vector2(0.2f, 0.2f), null, SpriteEffects.None, Color.White, 0f, 0.8f, true, 100, 25));
            entities.Add(new Enemy(AssetManager.SpriteAsset("enemy_ship"), new Vector2(50, 50), new Vector2(400, 400), new Vector2(0.2f, 0.2f), null, SpriteEffects.None, Color.White, 0f, 0.8f, true, 100, 25));
        ...
        public static void CreateBullet(Entity parent, Vector2 start, Vector2 target, bool isLaser)
        {
            ...
            #endregion
            AddBullet(new Bullet(AssetManager.SpriteAsset("projectile_green"), start, target, new Vector2(7, 7)/*maxBulletVelocity*/, new Vector2(0.5f, 0.5f)/*bulletScale*/, null, SpriteEffects.None, bulletColor, bulletRotation, bulletLayerDepth, bulletIsCollidable, parent, bulletDamage, bulletTimeToLive, isLaser));
        }
