...
namespace G01_Perseus
{
    public class Input
    {
        ...
        public static Vector2 MouseWorldPosition => new Vector2(Player.Position.X + 20, Player.Position.Y + 20) + Input.mouseState.Position.ToVector2() - new Vector2(Game1.camera.Viewport.Width / 2, Game1.camera.Viewport.Height / 2);
